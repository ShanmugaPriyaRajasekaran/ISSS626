...
:::insightbox
Power = 0.5
Weak distance decay - accessibility spreads widely across Singapore, creating a smooth pattern with minimal variation between near and far locations.

Power = 1.0
Moderate decay - clearer concentration around facilities emerges, but surrounding areas still maintain reasonable accessibility with visible gradients.

Power = 1.5
Strong decay - steep accessibility drop-off creates distinct service zones around each facility, highlighting spatial inequality between central and peripheral areas.

Power = 2.0
Very strong decay - accessibility highly localized immediately around facilities, with large regions showing near-zero access and sharp peaks at facility locations.

Power = 2.5
Extreme decay - accessibility limited to immediate facility vicinity, vast majority of Singapore shows minimal access, emphasizing critical importance of proximity.
