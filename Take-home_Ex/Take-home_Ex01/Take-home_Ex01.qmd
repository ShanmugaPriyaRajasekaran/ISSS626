...
::: insightbox
Insight All spatial analyses now run in metres (SVY21). This ensures distance-based quantities (nearest neighbour, KDE bandwidths) are numerically meaningful and edge-corrected by the true study window
:::
...
::: insightbox
Insight ST-KDE reveals when hotspots flare or fade. Using sector-specific spatial bandwidths and a common temporal bandwidth keeps maps comparable without over-smoothing small sectors.
:::
